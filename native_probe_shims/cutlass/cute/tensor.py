"""Minimal tensor objects for native FA4 import probing."""
...
class FakeTensor:
    ...
    This is intentionally lightweight: the native probe only needs tuple-like
    ``shape`` / ``stride`` metadata and an element type field so the CuTe
    Python stack can build compile keys without falling back to a dead
    placeholder object.
    """
